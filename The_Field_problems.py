...
def myFilter(L, num):
    ...
    Examples:
      ...
      [15, 25]
    '''
    return [val for val in L if val%num !=0]

print("myFileter: ", myFilter([1,2,4,5,7],2))
print("myFileter: ", myFilter([10,15,20,25],10))
...
def my_lists(L):
    ...
    [[], [1, 2, 3]]
    '''
    return [list(range(1, val+1)) for val in L]

print("my_lists: ", my_lists([1,2,4]))
print("my_lists: ", my_lists([0,3]))
...
f = {0:'a',1:'b'}
g = {'a':'apple','b':'banana'}
print("myFunctionComposition:", myFunctionComposition(f,g))

a = {'x':24,'y':25}
b = {24:'twentyfour',25:'twentyfive'}
print("myFunctionComposition: ", myFunctionComposition(a,b))
...
print("myProduct: ", myProduct([1,3,5]))
...
print("myMin: ", myMin([1,-100,2,3]))
print("myMin: ", myMin([0,3,5,-2,-5]))
...
print("myConcat: ", myConcat(['hello','world']))
...
print("myUnion: ", myUnion([{1,2},{2,3}]))
print("myUnion: ", myUnion([set(),{3,5},{3,5}]))
