...
print("Remainder of 2304811/47: \t", remainder_without_mod)

## 3: (Task 3) Divisibility
divisible_by_3 = ((673+909) % 3 == 0)
print("Is 673+909 divisible by 3?: ", divisible_by_3)
...
print("Value of expression is: \t", expression_val)



## 5: (Task 5) Squares Set Comprehension
first_five_squares = { x*x for x in {1,2,3,4,5} }
print("First five squares is: \t\t", first_five_squares)



## 6: (Task 6) Powers-of-2 Set Comprehension
first_five_pows_two = { 2**x for x in {0,1,2,3,4} }
print("First five powers of 2 is: \t", first_five_pows_two)
...
X1 = { 1, 2, 3 }
Y1 = { 5, 6, 7 }
double_comp = {x*y for x in X1 for y in Y1}
print("The double comprehension is: ", double_comp)
...
X2 = { 0, 2, 3 }
Y2 = { 4, 6, 9 }
print("Disjoint 5 elem set: \t\t", {x*y for x in X2 for y in Y2})
...
print("The intersection is \t\t", S_intersect_T)
...
print("Caretesian product of list", cartesian_product)
...
print("List of list sum: ", LofL_sum)
...
print("3 typle summing to zero: \t\t", zero_sum_list);
...
S = {-4, -2, 1, 2, 5, 0}
# Replace [ ... ] with a one-line list comprehension in which S appears
exclude_zero_list = [(x, y, z) for x in S for y in S for z in S if x+y+z==0 if x!=0 or y!=0 or z!=0]
print("3 tupe summing to zero without 0,0,0: \t", exclude_zero_list);
...
first_of_tuples_list = [(x, y, z) for x in S for y in S for z in S if x+y+z==0 if x!=0 or y!=0 or z!=0][0]
...
example_L = [1, 2, 2, 4]
print("Len(L) is diff from Len(List(set(L)): \t\t", len(list(set(example_L)))==len(example_L))
...
print("List of odd numbers <100: ", odd_num_list_range)
...
print("Range and zip: \t\t", range_and_zip)
...
print("List sum zip: \t\t\t", list_sum_zip)
...
print("Value list modified Bilbo: ", value_list_modified_1)
print("Value list modified Frodo: ", value_list_modified_2)
...
print("Identity function: \t\t", identity_dict)
...
representation_dict = { h*base**2 + t*base + u:(h, t, u) for u in digits for t in digits for h in digits }
print("Base dictionary: ", representation_dict)
...
print("Name to salary dict.: ", listdict2dict)
...
# Complete the procedure definition by replacing [ ... ] with a one-line list comprehension
def dict2list(dct, keylist): return [ dct.get(key, "NOT PRESENT") for key in keylist ]
print("Dict2List: \t \t", dict2list({'a':'A', 'b':'B', 'c':'C'},['b','c','a']))
...
print("list2dict:  \t\t", list2dict(['A','B','C'],['a','b','c']))

#Ungraded task for 3-digit procedure
def all_3_digit_number(base, digits) : return { h*base**2 + t*base + u for h in digits for t in digits for u in digits}
print("All 3 digit numbers: \t\n", all_3_digit_number(10, set(range(10))))